"%~dp0python-3.5.1-amd64.exe" /quiet /uninstall
ping 127.0.0.1 -n 20
"%~dp0python-3.5.1-amd64.exe" /quiet InstallAllUsers=1 PrependPath=1 DefaultAllUsersTargetDir="%ProgramFiles%\Python35"
ping 127.0.0.1 -n 20
